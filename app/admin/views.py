...
def scale_questions(page):
    ...
    return render_template(
        "admin/scale_questions/browse.html", questions=questions_result
    )
...
@login_required
@admin_required
def delete_scale_questions(question_id):
...
def screener_questions(page):
    ...
    return render_template(
        "admin/screener_questions/browse.html", questions=questions_result
    )
...
def text(text_type):
    ...
    return jsonify({"status": 1, "editable_html_obj": editable_html_obj.serialize})
...
def texts():
    ...
    return render_template(
        "admin/texts/index.html", editable_html_obj=editable_html_obj
    )
...
def added_trackingscript():
    ...
    return render_template("admin/trackingscript/added_trackingscript.html", data=data)
