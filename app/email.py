...
def send_email_old(recipient, subject, template, **kwargs):
    ...
    app.config["PREFERRED_URL_SCHEME"] = (
        os.environ.get("PREFERRED_URL_SCHEME") or "http"
    )
    ...
    app.config["MAIL_DEFAULT_SENDER"] = (
        os.environ.get("MAIL_DEFAULT_SENDER") or "MarketResearch.com.ng"
    )
    app.config["MAIL_DEFAULT_SENDER_NAME"] = (
        os.environ.get("MAIL_DEFAULT_SENDER_NAME") or "MarketResearch Ng Team"
    )
