...
class OrganisationForm(FlaskForm):
    org_name = StringField(
        "Organisation name", validators=[InputRequired(), Length(1, 64)]
    )
    ...
    org_industry = SelectField(
        ...
        choices=[
            ...
            ("Trash Collection/Waste Management", "Trash Collection/Waste Management"),
            ("Trucking", "Trucking"),
            ("Unions", "Unions"),
